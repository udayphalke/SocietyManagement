  ...
  <div class="col-sm-6">
    <div class="card" style="height:26rem;">
      <div class="card-body shadow p-3  rounded">
        <h5 class="card-title"><b>Generate Monthly Maintenance Bill</b></h5>
        <!-- form -->
        <div class="table-responsive">
                        ...
                        @csrf
                            ...
                            <label for="bdaymonth">Bill (month and year):</label>
                            <input type="month" id="bdaymonth" name="bdaymonth">
  
                                <small id="amenityHelp" class="form-text text-muted">Select Month and Year for the bill</small>
                            </div>

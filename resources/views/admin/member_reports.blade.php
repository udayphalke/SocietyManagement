...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    ...
    <li class="nav-item">
      <a href="staff_reports" class="nav-link text-dark font-italic bg-light">
    ...
    <li class="nav-item">
      <a href="visitor_reports" class="nav-link text-dark font-italic bg-light">
                <i class="fa fa-cubes mr-3 text-primary fa-fw"></i>
...
<!-- End vertical navbar -->
  ...
  <div class="row">
      <div class="col-sm-6">&nbsp; <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter Flat No:" title="Type Vehile No">&nbsp;<button onclick="exportToExcel('Members_Report')" class="btn btn-success">Export to Excel</button></div>
...
<div class="table-responsive">
        <table class=table border=1 id="Members_Report">
        <tr>
        <th class="thcolor">Sr.No.</td>
        <th class="thcolor">ID</th>
        <!-- <th class="thcolor">Society ID</th> -->
        <th class="thcolor">Name</th>
        <th class="thcolor">Flat No</th>
        <th class="thcolor">Birthdate</th>

        <th class="thcolor">Occupant Type</th>
        <th class="thcolor">Tenant Name</th>
        <th class="thcolor">Tenant Contact</th>
      ...
      <tr>
        ...
        <!-- <td>{{$u['society_id']}}</td> -->
        <td>{{$u['name']}}</td>
        <td width="500px">{{$u['flat_no']}}</td>
        <td>{{$u['birthdate']}}</td>

        <td>{{$u['occupant']}}</td>
        <td>{{$u['tenant_name']}}</td>
        <td>{{$u['tenant_contact']}}</td>
...
function myFunction() {
  ...
  table = document.getElementById("Members_Report");
...
function exportToExcel(tableID, filename = 'Members_Report'){
    var downloadurl;

    ...
    <div class="col-sm-12">
      <div class="card" >
        <div class="card-body shadow p-3  rounded">
          ...
          <h3 class="card-title" align="center">Member Entry Form</h3>
          ...
          @endif      
        <div class="container">
          <form action="member_entryform" method="POST">
          @csrf
            <!-- <div class="form-row"> 
            ...
            <div class="form-row">     
              <div class="form-group col-md-12">
                <input type="text" class="form-control" name="name" id="name" placeholder="Name" autocomplete required="">
              </div>
            </div>

            <div class="form-row">     
              <div class="form-group col-md-12">
                <input type="text" class="form-control" name="vehicle_no" id="vehicle_no" placeholder="Vehicle No." autocomplete required="">
              </div>
            </div>

            <div class="form-row"> 
              <div class="form-group col-md-12">
                <input type="date" class="form-control" name="entry_date" id="entry_date" value="<?php echo $todays_date;?>"  readonly>
              </div>
            </div>
            <div class="form-row"> 
              <div class="form-group col-md-12">
                <input type="time" class="form-control" name="entry_time" id="entry_time" value="<?php echo $todays_time;?>" readonly>
              </div>
            </div>

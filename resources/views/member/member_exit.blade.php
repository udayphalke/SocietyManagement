            ...
            <div class="card" >
                <div class="card-body shadow p-3  rounded">
                    <a href="/watchman" class="btn btn-primary">Back</a>
                        <h5 class="card-title" align="center"> Members Exit Form</h5>
                            <div class="container">
                                <form action="/member_exit" method="POST">
                                @csrf
                                ...
                                <div class="form-row"> 
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="vehicle_no" value="{{$member['vehicle_no']}}" readonly>
                                    </div>
                                ...
                                <div class="form-row"> 
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="entry_date" value="{{$member['entry_date']}}" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="entry_time" value="{{$member['entry_time']}}" readonly>
                                    </div>
                                </div>

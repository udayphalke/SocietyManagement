...
<div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/member_record"><b>Members Entry-Exit Record</b></a>
      </li>
...
<center><h1>Members Record</h1></center>
<div style="overflow-x:auto;">

<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Member Name" title="Type Member Name here">

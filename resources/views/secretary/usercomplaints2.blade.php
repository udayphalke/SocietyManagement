...
<td>{{$c['status']}}</td>
<td><a href={{"solve2/".$c['id']}}><button type="button" class="btn btn-success">Take Action</button></a></td>
<td><a href={{"view2/".$c['user_id']}}><button type="button" class="btn btn-success">View</button></a></td>
